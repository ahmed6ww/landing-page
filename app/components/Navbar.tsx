      ...
      <div className="navbar drop-shadaow p-10 h-16  text-secondary sticky top-0 z-[1000] bg-black">
        ...
        Sign Up
          ...
          <Link href="https://presale.benefitmine.io/" target="_blank">
            <button className="relative hidden md:flex h-10 overflow-hidden rounded-full p-[2px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50">
