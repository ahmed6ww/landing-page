...
<motion.a
                    variants={FADE_DOWN_ANIMATION_VARIANTS}  href="#Signup" className="mt-6 md:mt-4 relative inline-flex items-center justify-start px-8 py-3 overflow-hidden font-bold rounded-full group">
