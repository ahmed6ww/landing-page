              ...
              <>
                ...
                >
                  ...
                  <div className="flex flex-col w-80%] md:w-[40%] ">
                    ...
                    <div>
                    <motion.a
                    variants={FADE_DOWN_ANIMATION_VARIANTS}  href={cont.href} target="_blank" className="mt-8 md:mt-6 relative z-20 inline-flex items-center justify-start px-7 py-3 overflow-hidden font-bold rounded-full group">
